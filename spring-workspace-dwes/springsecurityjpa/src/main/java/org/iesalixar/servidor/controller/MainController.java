...
public class MainController {
	...
	public String asignaturas(Model model) {
		...
		List<Asignatura> asignaturas = asignaturaService.getAllAsignatura();
	...
	@GetMapping("/departamentInsert")
	public String departamentInsertGet(Model model) {
	...
	@PostMapping("/departamentInsert")
	public String departamentInsertPost(@ModelAttribute Departamento departamento) {
		
		Departamento departamentoBD = new Departamento();
		departamentoBD.setNombre(departamento.getNombre());
		
		departamentoBD = departamentoService.insertDepartamento(departamentoBD);
		
		if (departamentoBD==null) {
			return "redirect:/departamentInsert";
		}
